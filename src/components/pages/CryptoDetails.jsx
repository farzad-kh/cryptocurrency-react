...
const CryptoDetails = () => {
  ...
  const { data: coinHistory, isFetching: coinHistoryFeching } =
  ...
  if ((isFetching && cryptoDetails?.length === 0) || coinHistory === undefined)
    ...
    <Col className="coin-detail-container">
      ...
      >
        <div level={2} className="show-more mb-6 !text-[0.90rem]">
          <div
            className="cursor-pointer hover:text-cyan-600 w-fit border-b border-stone-500 hover:border-cyan-400"
        ...
        <Select
          defaultValue="24h"
          className="select-timeperiod ml-3"
        ...
        <Col className="coin-desc-link px-0  md:mx-0 justify-center items-center mb-6  ">
          <Col className="coin-links px-0 flex-1">
            <Title
              level={3}
              className="coin-details-heading px-0 mx-4 md:mx-0 my-3"
            >
